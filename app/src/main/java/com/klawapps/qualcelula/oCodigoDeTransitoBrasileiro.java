...
public class oCodigoDeTransitoBrasileiro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_o_codigo_de_transito_brasileiro);
        ...
        htmlTextView.setHtml("<h4>O C&oacute;digo de Tr&acirc;nsito Brasileiro</h4>\n" +
              ...
              toolbarprincipal.setSubtitle("O Código ");
    }
